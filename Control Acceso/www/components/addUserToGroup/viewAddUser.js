import addUserController from './controllerAddUser.js';
...
class addUserView extends HTMLElement{
    constructor(model){
        ...
        this.innerController = new addUserController(this, this.innerModel);
        ...
        this.addUserTitle.innerText = "Add User to Group";
...
customElements.define('x-addutog', addUserView);
