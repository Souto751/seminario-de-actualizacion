import deleteUserController from './controllerEditUser.js';
...
class createUserView extends HTMLElement{
    constructor(model){
        ...
        this.createUserTitle.innerText = "Edit User";
        ...
        this.editSpanName.innerText = "Username:"
        ...
        this.editSpanDesc.innerText = "Password:"
        
        this.editDesc = document.createElement("input");
        this.editDesc.id = "group-desc";
        this.editDesc.setAttribute("maxlength", "16");
        this.editDesc.setAttribute("type", "password");
    ...
    connectedCallback(){
        ...
        this.editDesc.addEventListener('input', (e) => {
...
customElements.define('x-edituser', createUserView);
